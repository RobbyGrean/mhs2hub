...
ศูนย์การเรียนรู้สำหรับดูระบบจริงเป็นต้นแบบ โดยเชื่อมไปยัง Phonebook, ทะเบียนครุภัณฑ์, jmoney, picturemhs2, PassaduAIagent, ระบบ Inventory ที่กำลังพัฒนา และระบบเช็คชื่อออนไลน์
